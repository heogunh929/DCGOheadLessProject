# L0185_replacement_counter_cut_in - replacement/counter/cut-in common layer blocker 2
...
- BatchId: `L0185_replacement_counter_cut_in`
- Kind: `mechanic-layer`
...
| --- | --- | --- | ---: | ---: |
| `timings` | `WhenWouldLink` | `NeedsSourceReview` | 2 | 3 |
